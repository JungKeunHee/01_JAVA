...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *   구현 몸체(영억) 을 새롭게 다시 작성을 한 것이다.
        *   메소드를 재정의하게 된다면 재정의한 메소드가 우선 동작을 한다.
        *  */

        /* comment.
        *   이렇게 우리가 상속이라고 하는 기술을 사용하게 되면 얻는 장점
        *   1. 새로운 클래스를 작성할 시 기존의 작성한 클래스를 재사용 할 수 있다.
        *     1-1. 재사용 시 생산성을 크게 향상시킬 수 있다.(새롭게 작성 안 해도 됨)
...
//        fireCar.isRunning();
        ...
        /* index. 3. 소방차가 너무 재미없게 경적을 울린다..
            그리고 소방차는 물을 뿌리는 기능이 있으면 좋지 않을까? */
