...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        *  */
        ...
        hmap.put(12, "Blue Moon");

        System.out.println("hmap = " + hmap);

        /* index. 3. 값은 중복저장이 되는 지 확인 */
        // key 값이 중복되지 않는다면 value 는 중복 저장이 가능하다.
        hmap.put(11, "Blue Moon");
        System.out.println("hmap = " + hmap);

        /* index. 4. Map 에 저장된 값 꺼내기 */
        System.out.println("12번 키의 해당하는 값 : " + hmap.get(12));

        hmap.remove(12);
        System.out.println("hmap = " + hmap);

        // 저장 된 객체 수 확인 size() 메소드
        System.out.println("hamp 에 저장 된 객체 수 : " + hmap.size());
        ...
        hmap2.put("five", "jpa");
         ...
         /* index. 1. ketSet() 을 이용해서 키만 따로 Set 으로 만들고, iterator() 로 목록 만들기 */
