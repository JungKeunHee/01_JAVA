...
//        그 외에 본인이 만들고 싶은 예외사항 있으면 얼마든지 추가 가능
        ...
        char operation = sc.next().charAt(0);
            ...
            Calculrator.calculrator(first, second, operation);

            System.out.println("==========선택한 정수 값 및 연산기호==========");
            System.out.println("첫 번째 정수 값 : " + first + " 두 번째 정수 값 : " + second + " 사칙연산 : " + operation);
            System.out.println("==========================================");

        System.out.println();

            System.out.println("==============결과 값 안내==============");
            System.out.println("결과 값 : " + Calculrator.calculrator(first, second, operation));
            System.out.println("======================================");
