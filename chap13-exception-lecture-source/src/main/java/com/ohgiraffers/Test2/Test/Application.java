...
//        그 외에 본인이 만들고 싶은 예외사항 있으면 얼마든지 추가 가능
        ...
        switch (operation){
            case '+':
                System.out.println(Calculrator.sum(first, second));
                break;
            case '-':
                System.out.println(Calculrator.minus(first, second));
                break;
            case '*':
                System.out.println(Calculrator.multi(first, second));
                break;
            case '/':
                System.out.println(Calculrator.div(first, second));
                break;
            case '%':
                System.out.println(Calculrator.remain(first, second));
                break;
            default:
